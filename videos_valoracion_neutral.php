        ...
        <div class="col-sm-12">
            <div class="page-header">
                <div class="page-title text-center">
                    <h1 class="text-muted">Vídeos con valoración neutral</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="panel panel-primary mt-3">
                    <table id="tabla_valoraciones" class="table table-striped table-bordered table-responsive-sm">
                        ...
                        <tbody id="tabla" class="pb-3">
                            <?php
                            $valoraciones = $db->GetAllRatingsVideos(0);
                            ?>
                            ...
                            { ?>
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;" class="text-center"><i class="fa fa-star-half-o text-warning"></i>&nbsp;&nbsp;0</td>  
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
        ...
        buttons: [
            {
                ...
                filename: 'Vídeos con valoración neutral',
                            ...
                            columns: [
                                {
                                    alignment: 'center',
                                    fontSize: 16,
                                    text: 'Vídeos con valoración neutral'
                                }
                            ],
                            margin: 20
                        }
