        ...
        <div class="col-sm-12">
            <div class="page-header">
                <div class="page-title text-center">
                    <h1 class="text-muted">Registro total de valoraciones</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="panel panel-primary mt-3">
                    <table id="tabla_valoraciones" class="table table-striped table-bordered table-responsive-sm">
                        ...
                        <tbody id="tabla" class="pb-3">
                            <?php
                            $valoraciones = $db->buscar_comentarios();
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;" class="text-center">
                                        ...
                                        if($valoracion['valoracion'] == 1)
                                            { ?> <i class="fa fa-star text-warning"></i>&nbsp;&nbsp;1<?php } 
                                        else if($valoracion['valoracion'] == -1) 
                                            { ?> <i class="fa fa-star-o text-warning"></i>&nbsp;&nbsp;-1<?php } 
                                                else if(($valoracion['valoracion'] == 0)) 
                                                    { ?> <i class="fa fa-star-half-o text-warning"></i>&nbsp;&nbsp;0<?php } ?>
                                    </td>  
                                </tr>
                            <?php } ?>
                        </tbody>
        ...
        buttons: [
            {
                ...
                filename: 'Registro total de valoraciones',
                            ...
                            columns: [
                                {
                                    alignment: 'center',
                                    fontSize: 16,
                                    text: 'Registro total de valoraciones'
                                }
                            ],
                            margin: 20
                        }
