...
$db = new funciones_BD();
$sucursal = $db->GetEmpresaName($_GET['empresa']);
?>
        ...
        <div class="col-sm-12">
            <div class="page-header">
                <div class="page-title text-center">
                    <h1 class="text-muted">Ingresos por Empresa de <?=$sucursal ?></h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="panel panel-primary mt-3">
                    <table id="tabla_usuarios" class="table table-striped table-bordered table-responsive-sm">
                        ...
                        <tbody id="tabla" class="pb-3">
                            <?php
                            $id_sucursal = $_GET['empresa'];
                            $empresas = $db->GetLogsUsersFromEmpresa($id_sucursal);
                            ?>

                            <?php foreach ($empresas as $empresa)
                            { ?>
                                <tr>
                                    <td style="vertical-align: middle;"><?=$empresa['nombre']; ?></td>
                                    <td style="vertical-align: middle;"><?=$empresa['apellido']; ?></td>
                                    <td style="vertical-align: middle;"><?=$empresa['cedula']; ?></td>
                                    <td style="vertical-align: middle;"><?=$empresa['telefono']; ?></td>  
                                    <td style="vertical-align: middle;"><?=$empresa['correo']; ?></td>  
                                    <td style="vertical-align: middle;"><?=$empresa['nombre_sucursal']; ?></td>
                                    <td style="vertical-align: middle;"><?=$empresa['last_date']; ?></td>
                                    <td style="vertical-align: middle;" class="text-center"><?=$empresa['cont_logs']; ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
        ...
        buttons: [
            {
                ...
                filename: 'Ingresos por Empresa de <?=$sucursal ?>',
                            ...
                            columns: [
                                {
                                    alignment: 'center',
                                    fontSize: 16,
                                    text: 'Ingresos por Empresa de <?=$sucursal ?>'
                                }
                            ],
                            margin: 20
                        }
